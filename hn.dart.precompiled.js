...
["", "hn.dart", , Q, {
  "^": "",
  main: [function() {
    W.HttpRequest_getString("https://hacker-news.firebaseio.com/v0/topstories.json", null, null).then$1(Q.getStories$closure());
  }, "call$0", "main$closure", 0, 0, 1],
  getStories: [function(data) {
    var decoded, t1, max_items, i, t2, t3, result;
    decoded = C.JsonCodec_null_null.decode$1(data);
    t1 = J.getInterceptor$asx(decoded);
    max_items = P.min(t1.get$length(decoded), 30);
    for (i = 0; i < max_items; ++i) {
      t2 = J.toString$0(t1.$index(decoded, i));
      if (typeof t2 !== "string")
        H.throwExpression(P.ArgumentError$(t2));
      t2 = W.HttpRequest_getString(H.stringReplaceFirstUnchecked("https://hacker-news.firebaseio.com/v0/item/ID.json", "ID", t2, 0), null, null);
      t3 = $.Zone__current;
      t3.toString;
      result = new P._Future(0, t3, null, null, new Q.getStories_closure(), null, P._registerErrorHandler(null, t3), null);
      result.$builtinTypeInfo = [null];
      t2._addListener$1(result);
    }
  }, "call$1", "getStories$closure", 2, 0, 6],
  getStories_closure: {
    "^": "Closure:10;",
    call$1: function(str) {
      var obj, t1, t2, e, t3, t4;
      obj = C.JsonCodec_null_null.decode$1(str);
      t1 = J.get$children$x(document.querySelector("#hn"));
      t2 = document.createElement("li", null);
      e = document.createElement("a", null);
      t3 = J.getInterceptor$asx(obj);
      t4 = J.getInterceptor$x(e);
      t4.set$href(e, t3.$index(obj, "url"));
      e.textContent = t3.$index(obj, "title");
...
//# sourceMappingURL=hn.dart.js.map
{
  var message =
...
function dart_precompiled($collectedClasses) {
  ...
  function getStories_closure() {
  }
  getStories_closure.builtin$cls = "getStories_closure";
  if (!"name" in getStories_closure)
    getStories_closure.name = "getStories_closure";
  $desc = $collectedClasses.getStories_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  getStories_closure.prototype = $desc;
